...
export default function SecuritySettings({ supabase, setToast, onSendPasswordReset }) {
  ...
  return (
    <>
      ...
      <div className="settings-actions">
        <button className="ghost" type="button" onClick={onSendPasswordReset}>
        ...
        <p className="muted">
          This page sets up 2FA first. The login challenge can be enabled after this deploy proves stable.
        </p>
